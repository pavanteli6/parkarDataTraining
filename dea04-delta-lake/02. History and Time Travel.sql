...
DESCRIBE HISTORY newpavancatalog.delta_lake.companies;
...
SELECT * FROM newpavancatalog.delta_lake.companies
TIMESTAMP AS OF '2025-11-06T04:16:50.000+00:00';
...
RESTORE TABLE newpavancatalog.delta_lake.companies VERSION AS OF 1;
